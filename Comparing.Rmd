...
overlapping_genes <- cbind(overlapping_genes,overlap_C$SCORE)
colnames(overlapping_genes) <- c("GENES","SCORE")
#overlapping_genes <- subset(overlapping_genes,select = c(3,2))

#write.csv(overlapping_genes,"Sig-overlapping-genes-pen-elife.txt")
