...
ASevents <- rbind(Cellcycle_RI_JC,Cellcycle_SE_JC,Cellcycle_A3SS_JC,Cellcycle_A5SS_JC,Cellcycle_MXE_JC)
ASevents = as.data.frame(ASevents)

#ASevents <- na.omit(ASevents)
