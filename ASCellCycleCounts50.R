...
Cellcycle_RI_JC = unite(Cellcycle_RI_JC,"Position",c(4:12),sep = ":",remove = T)
...
Cellcycle_RI_JC50$PSIDiff <- (apply(Cellcycle_RI_JC50[37:50], MARGIN =  1, f,))
...
Cellcycle_SE_JC = unite(Cellcycle_SE_JC,"Position",c(4:12),sep = ":",remove = T)
...
Cellcycle_SE_JC50$PSIDiff <- (apply(Cellcycle_SE_JC50[37:50], MARGIN =  1, f,))
...
Cellcycle_A3SS_JC = unite(Cellcycle_A3SS_JC,"Position",c(4:12),sep = ":",remove = T)
...
Cellcycle_A3SS_JC50$PSIDiff <- (apply(Cellcycle_A3SS_JC50[37:50], MARGIN =  1, f,))
...
Cellcycle_A5SS_JC = unite(Cellcycle_A5SS_JC,"Position",c(4:12),sep = ":",remove = T)
...
Cellcycle_A5SS_JC50$PSIDiff <- (apply(Cellcycle_A5SS_JC50[37:50], MARGIN =  1, f,))
...
Cellcycle_MXE_JC = unite(Cellcycle_MXE_JC,"Position",c(4:14),sep = ":",remove = T)
...
Cellcycle_MXE_JC50$PSIDiff <- (apply(Cellcycle_MXE_JC50[37:50], MARGIN =  1, f,))
...
ASevents50Diffclean = subset(ASevents50Diff,select = c(54,3,2,4,38:40,47:48,41:43,49:51,44:46))
